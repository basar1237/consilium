...
async function main() {
  ...
  const blogPosts = [
    {
      ...
      description: 'As organisations face an increasingly volatile risk landscape, the role of enterprise risk management is evolving rapidly.',
      content: richText(
        paragraph(text('The discipline of enterprise risk management has undergone a remarkable transformation over the past decade, and 2026 marks a pivotal moment in its evolution. Organisations across the United Kingdom and beyond are grappling with a risk landscape that is more interconnected, more volatile, and more complex than at any point in living memory.')),
        paragraph(text('One of the most significant trends we observe is the integration of risk management into strategic decision-making at the highest levels of the organisation. Boards and executive committees are increasingly recognising that effective risk management is not merely a compliance obligation but a source of competitive advantage.')),
        paragraph(text('Technology is playing an increasingly central role in this transformation. Advanced analytics, artificial intelligence, and real-time data are enabling risk functions to move from periodic, backward-looking assessments to continuous, forward-looking monitoring.')),
        paragraph(text('However, technology alone is not sufficient. The most effective risk functions combine sophisticated tools with strong risk culture, clear governance, and deep expertise. As we look ahead, the organisations that will thrive are those that invest in building risk capabilities that are genuinely embedded in the fabric of their operations.')),
        paragraph(text('At Consilium, we work with clients across sectors to build risk management frameworks that are fit for the future — frameworks that are proportionate, pragmatic, and aligned with strategic objectives.')),
      ),
    },
    {
      ...
      description: 'ISO 31000 provides a globally recognised framework for risk management, but how should UK businesses apply it in practice?',
      content: richText(
        paragraph(text('ISO 31000 is the international standard for risk management, providing principles, a framework, and a process that can be applied by any organisation regardless of size, sector, or complexity.')),
        paragraph(text('For UK businesses, the practical application of ISO 31000 begins with understanding the organisation\'s internal and external context. This means considering the regulatory environment, stakeholder expectations, industry dynamics, and the organisation\'s own strategic objectives and risk appetite.')),
        heading('h2', text('The Risk Assessment Process')),
        paragraph(text('The risk assessment process — comprising risk identification, risk analysis, and risk evaluation — forms the heart of the standard. Effective risk identification requires input from across the organisation, drawing on the knowledge and experience of people at every level.')),
        heading('h2', text('Risk Treatment Options')),
        paragraph(text('Risk treatment options include avoiding the risk, accepting the risk, modifying the likelihood or consequences, sharing the risk, or retaining the risk by informed decision. The choice of treatment should be proportionate and informed by a clear understanding of costs, benefits, and feasibility.')),
        paragraph(text('Communication, monitoring, and review are essential to ensuring that the risk management framework remains effective over time.')),
      ),
    },
    {
      ...
      description: 'Recent global disruptions have highlighted the importance of operational resilience for UK organisations.',
      content: richText(
        paragraph(text('The past several years have provided a series of stark reminders about the importance of operational resilience. From the global pandemic and its cascading effects on supply chains and workforces, to significant technology outages and geopolitical events, organisations have faced unprecedented levels of disruption.')),
        heading('h2', text('Key Lessons')),
        paragraph(text('One of the most important lessons from recent disruptions is the critical role of third-party dependencies. Many organisations discovered that their resilience was only as strong as that of their key suppliers and service providers.')),
        paragraph(text('Another key lesson concerns the importance of scenario testing and exercising. Organisations that had invested in regular, realistic exercises were significantly better prepared to respond when actual disruption occurred.')),
        paragraph(text('Communication also emerged as a critical factor. Organisations that had clear, pre-established communication protocols were able to manage stakeholder expectations more effectively during periods of disruption.')),
        paragraph(text('Looking ahead, the organisations that build the strongest resilience capabilities will be those that treat operational resilience as a continuous discipline, not a one-off compliance exercise.')),
      ),
    },
    {
      ...
      description: 'Cyber risk is a board-level concern, yet many directors lack the technical background to engage effectively.',
      content: richText(
        paragraph(text('Cyber risk has firmly established itself as one of the most significant threats facing organisations of all sizes and across all sectors. For board directors, the challenge is clear: they are ultimately accountable for the organisation\'s risk management, including cyber risk.')),
        heading('h2', text('Key Principles for Board Directors')),
        paragraph(text('First, directors should understand that cyber risk is a business risk, not merely a technology risk. A significant cyber incident can result in financial losses, regulatory penalties, reputational damage, and operational disruption.')),
        paragraph(text('Second, boards should ensure that the organisation has a clear understanding of its most critical digital assets and the threats they face.')),
        paragraph(text('Third, governance arrangements should be clear and effective. This includes defining roles and responsibilities for cyber risk management and establishing reporting lines to the board.')),
        paragraph(text('Fourth, incident response planning is essential. Boards should ensure that a tested incident response plan is in place.')),
        paragraph(text('Finally, boards should foster a culture of cyber awareness throughout the organisation. Human error remains one of the most common causes of cyber incidents.')),
      ),
    },
    {
      ...
      description: 'Regulatory change is a constant for UK businesses. We outline a strategic, risk-based approach to managing change effectively.',
      content: richText(
        paragraph(text('For organisations operating in regulated sectors in the United Kingdom, the pace and volume of regulatory change shows no sign of abating.')),
        heading('h2', text('Building a Strategic Approach')),
        paragraph(text('The first step in developing a strategic approach to regulatory change is establishing a robust horizon-scanning capability. This means systematically monitoring regulatory developments across all relevant jurisdictions and regulators.')),
        paragraph(text('Once potential changes have been identified, they should be assessed against a consistent set of criteria to determine their significance and urgency.')),
        heading('h2', text('Implementation and Training')),
        paragraph(text('Implementation planning should begin early and involve all relevant stakeholders. Regulatory change often has implications that extend well beyond the compliance function.')),
        paragraph(text('Training and communication are essential components of any change programme. Staff need to understand not only what is changing but why, and what it means for their day-to-day activities.')),
        paragraph(text('Finally, organisations should build feedback loops into their change management process. Post-implementation reviews help to identify lessons learned and refine the process for future use.')),
      ),
    },
    {
      ...
      description: 'Internal audit is evolving from a traditional assurance function to a strategic partner in risk governance.',
      content: richText(
        paragraph(text('The role of internal audit within organisations has evolved significantly in recent years, moving beyond its traditional focus on financial controls and compliance to become a strategic partner in risk governance.')),
        heading('h2', text('Drivers of Change')),
        paragraph(text('This shift is being driven by several factors. First, the risk landscape has become significantly more complex. Second, regulators are placing greater emphasis on the role of internal audit. Third, stakeholder expectations are rising.')),
        heading('h2', text('Risk-Based Approach')),
        paragraph(text('To meet these expectations, internal audit functions need to adopt a genuinely risk-based approach to planning and execution. This means moving beyond cyclical audit plans to dynamic plans that are responsive to changes in the organisation\'s risk profile.')),
        paragraph(text('Technology is playing an increasingly important role in enhancing the efficiency and effectiveness of internal audit. Data analytics, continuous monitoring tools, and automation are enabling audit teams to cover more ground and provide richer insights.')),
        paragraph(text('At Consilium, we support organisations in building internal audit capabilities that are fit for purpose, whether through fully outsourced engagements, co-sourced arrangements, or targeted advisory projects.')),
      ),
    },
  ]
  ...
  const homePage = await api(
    '/pages',
    {
      ...
      layout: [
        ...
        },
        {
          ...
          cards: [
            ...
            { title: 'Regulatory Programmes', description: 'Build sustainable compliance programmes that keep pace with regulatory expectations.', href: '/services/regulatory-compliance' },
            { title: 'Resilience Testing', description: 'Validate your operational resilience through scenario testing and business impact analysis.', href: '/services/operational-resilience' },
            { title: 'Cyber Governance', description: 'Establish board-level cyber risk governance and incident response capabilities.', href: '/services/cyber-risk-advisory' },
          ],
        },
        {
        ...
        },
        {
          ...
          steps: [
            ...
            { title: 'Assessment', description: 'Structured analysis of your risk environment, identifying gaps, strengths, and priorities.' },
            { title: 'Design', description: 'Developing tailored frameworks, policies, and tools that fit your context.' },
        ...
        },
        {
          ...
          services: [
            { title: 'Enterprise Risk Management', shortDescription: 'Comprehensive risk management frameworks tailored to your organisation\'s strategic objectives.', slug: 'enterprise-risk-management' },
            { title: 'Regulatory Compliance', shortDescription: 'Navigate complex regulatory landscapes with confidence through expert guidance.', slug: 'regulatory-compliance' },
            { title: 'Operational Resilience', shortDescription: 'Build resilient operations that can withstand disruption and deliver critical services.', slug: 'operational-resilience' },
            { title: 'Cyber Risk Advisory', shortDescription: 'Protect your digital assets and manage cyber threats with a risk-informed approach.', slug: 'cyber-risk-advisory' },
            { title: 'Internal Audit', shortDescription: 'Independent assurance and advisory services that add value to your operations.', slug: 'internal-audit' },
            { title: 'Strategic Risk Consulting', shortDescription: 'Align risk management with corporate strategy to protect and create value.', slug: 'strategic-risk-consulting' },
          ],
        },
        {
        ...
        },
        {
          ...
          faqs: [
            ...
            { question: 'How long does a typical engagement last?', answer: 'Engagement length varies. A focused risk assessment might take 4-6 weeks, while a comprehensive framework implementation could span 3-6 months.' },
            ...
            { question: 'What makes Consilium different?', answer: 'Every engagement is led by senior consultants with deep expertise — not delegated to junior staff. We offer the quality of a large firm with the agility of a specialist practice.' },
          ],
        },
        {
      ...
      meta: {
        ...
        description: 'Professional risk advisory and management services for UK businesses. Enterprise risk management, regulatory compliance, operational resilience, and more.',
      },
    },
    token,
  )
      ...
      layout: [
        ...
        },
        {
          ...
          highlights: [
            ...
            { icon: 'lightbulb', title: 'Innovation', description: 'We continuously evolve our methods and thinking to help clients stay ahead of emerging risks and opportunities.' },
          ],
        },
        {
          blockType: 'finalCta',
      ...
      layout: [
        {
          ...
          subtitle: 'Trusted by organisations across the UK for risk advisory and management services',
          testimonials: [
            { quote: 'Consilium transformed our approach to enterprise risk management. Their team brought clarity to a complex landscape and delivered a framework that has genuinely improved our decision-making at board level.', name: 'Richard Pemberton', role: 'Chief Financial Officer', company: 'Meridian Financial Services' },
            { quote: 'The operational resilience programme Consilium designed for us was outstanding. They understood our regulatory obligations and translated them into practical, proportionate measures that our teams could actually implement.', name: 'Catherine Wells', role: 'Chief Risk Officer', company: 'Northern Gateway Insurance' },
            { quote: 'We engaged Consilium to support our internal audit function during a period of significant organisational change. Their consultants were professional, thorough, and delivered findings that added real value to the business.', name: 'Andrew Forsyth', role: 'Head of Risk', company: 'Sterling Manufacturing Group' },
            { quote: 'Consilium\'s cyber risk advisory service gave our board the confidence and visibility we needed to fulfil our governance responsibilities. Their ability to translate technical risks into business language was particularly valuable.', name: 'Helen Cartwright', role: 'Managing Director', company: 'Atlas Property Holdings' },
            { quote: 'Navigating the regulatory landscape in healthcare is extraordinarily complex. Consilium provided the expertise and structured approach we needed to build a compliance programme that is both robust and sustainable.', name: 'Jonathan Drake', role: 'Group Compliance Director', company: 'Whitmore Healthcare Partners' },
            { quote: 'As a non-executive, I value independent, high-quality assurance. Consilium\'s strategic risk consulting gave us a clear picture of our risk exposure during a critical period of growth and acquisition.', name: 'Fiona MacLeod', role: 'Non-Executive Director', company: 'Caledonian Energy Ltd' },
          ],
        },
        {
          blockType: 'finalCta',
    ...
    '/pages',
    {
      ...
      layout: [
          ...
          columns: [
            {
              ...
              richText: richText(
                ...
                paragraph(text('The international standard for risk management — principles, framework, and process')),
                paragraph(text('ISO 31000 provides guidelines on managing risk faced by organisations. It can be customised to any organisation and its context, providing a common approach to managing any type of risk. Consilium helps UK businesses implement ISO 31000 in a practical, proportionate way.')),
              ),
            },
          ],
        },
        {
          ...
          title: 'Key Areas',
          description: 'Understanding the core components of the ISO 31000 risk management standard.',
          faqs: [
            { question: 'Risk Assessment', answer: 'Risk assessment is the overall process of risk identification, risk analysis, and risk evaluation. It provides the evidence base for informed decisions about how to treat particular risks and select between options.' },
            { question: 'Risk Treatment', answer: 'Risk treatment involves selecting and implementing options for addressing risk. Options include avoiding the risk, taking or increasing risk to pursue an opportunity, removing the risk source, changing the likelihood, changing the consequences, sharing the risk, or retaining the risk by informed decision.' },
            { question: 'Risk Monitoring & Review', answer: 'Monitoring and review should take place in all stages of the risk management process. It includes planning, gathering and analysing information, recording results, and providing feedback. Results should be incorporated throughout the organisation\'s performance management.' },
            { question: 'Risk Communication', answer: 'Communication and consultation with external and internal stakeholders should take place during all stages of the risk management process. Plans should address issues relating to the risk itself, its causes, its consequences, and the measures being taken to treat it.' },
            { question: 'Risk Framework', answer: 'The framework provides the foundations and organisational arrangements for designing, implementing, monitoring, reviewing, and continually improving risk management throughout the organisation. It should be integrated into the organisation\'s overall strategy and governance.' },
          ],
        },
        {
          blockType: 'finalCta',
  ...
  const contactPage = await api(
    '/pages',
    {
      ...
      meta: {
        ...
        description: 'Get in touch with Consilium Risk Advisory Group for risk management consultation.',
      },
    },
    token,
  )
  ...
  const servicePages = [
    ...
    },
    {
      ...
      description: 'Navigate complex regulatory landscapes with confidence through expert guidance and structured compliance programmes.',
      fullContent: richText(
        heading('h2', text('Regulatory Compliance')),
        paragraph(text('Regulatory demands continue to grow in scope and complexity across every sector. Our Regulatory Compliance service helps organisations understand their obligations, identify gaps in current arrangements, and implement sustainable compliance programmes.')),
        paragraph(text('From initial gap analysis through to ongoing monitoring and training, we provide the tools and expertise needed to stay ahead of regulatory change. Our approach is proportionate and risk-based, ensuring your compliance efforts are focused where they matter most.')),
        heading('h3', text('Key Features')),
        bulletList(
    ...
    },
    {
      ...
      description: 'Build resilient operations that can withstand disruption and continue to deliver critical services to customers.',
      fullContent: richText(
        heading('h2', text('Operational Resilience')),
        paragraph(text('Operational resilience has moved to the top of the regulatory and boardroom agenda. We help organisations identify their important business services, set impact tolerances, and develop robust testing programmes to validate their ability to remain within tolerance during severe but plausible scenarios.')),
        paragraph(text('Our consultants support you across the full resilience lifecycle, from business impact analysis and third-party dependency mapping to recovery planning and lessons-learned exercises.')),
        heading('h3', text('Key Features')),
        bulletList(
    ...
    },
    {
      ...
      description: 'Protect your digital assets and manage cyber threats with a risk-informed approach to information security.',
      fullContent: richText(
        heading('h2', text('Cyber Risk Advisory')),
        paragraph(text('Cyber threats pose one of the most significant risks to modern organisations, yet many struggle to translate technical vulnerabilities into business risk language. Our Cyber Risk Advisory service bridges this gap by providing board-level insight into your cyber risk posture.')),
        paragraph(text('We work alongside your technology teams to ensure that cyber risk is managed as an integral part of your wider enterprise risk framework, not as a siloed technical concern.')),
        heading('h3', text('Key Features')),
        bulletList(
    ...
    },
    {
      ...
      description: 'Independent assurance and advisory services that add value and improve your organisation\'s operations.',
      fullContent: richText(
        heading('h2', text('Internal Audit')),
        paragraph(text('Effective internal audit is a cornerstone of good governance, providing independent assurance to boards and audit committees on the adequacy of risk management, control, and governance processes.')),
        paragraph(text('Our Internal Audit service offers flexible engagement models, from fully outsourced internal audit functions to co-sourced arrangements that supplement your in-house team. We take a risk-based approach to audit planning, focusing resources on the areas of greatest significance.')),
        heading('h3', text('Key Features')),
        bulletList(
    ...
    },
    {
      ...
      description: 'Align risk management with corporate strategy to protect and create value in an uncertain environment.',
      fullContent: richText(
        heading('h2', text('Strategic Risk Consulting')),
        paragraph(text('Strategic risks can fundamentally alter an organisation\'s trajectory, yet they are often the least well managed. Our Strategic Risk Consulting service helps leadership teams identify, assess, and respond to risks that could impact strategic objectives.')),
        paragraph(text('From evaluating the risk implications of mergers and acquisitions to embedding a proactive risk culture and horizon-scanning for emerging threats, we ensure that risk management is a strategic enabler rather than a compliance exercise.')),
        heading('h3', text('Key Features')),
        bulletList(
